...
| 3 | KV ≥ 95% for ≥ 10 simulated minutes. Preemptions > 0. Recomputed prefill ≥ 10% of prefill tokens in that window. nvidia-smi-style utilization ≥ 90% while compute utilization ≤ 50%. TTFT p99 ≥ 3× its pre-moment value while token throughput stays within 10%. |
